...
namespace EpsSchool.Tests.HandlersTests
{
    ...
    public class CreateTeacherHandlerTests
    {
        ...
        private readonly CreateTeacherCommand _validCommand = new CreateTeacherCommand("Enrique", "Souza",
        ...
        {
            _result = (GenericCommandResult)await _handler.TeacherHandle(_invalidCommand);
            Assert.AreEqual(_result.Success, false);
        }

        [TestMethod]
        [TestCategory("Handler")]
        public async Task Dado_um_comando_valido_o_manipulador_deve_criar_o_registro_de_professor()
        {
            _result = (GenericCommandResult)await _handler.TeacherHandle(_validCommand);
