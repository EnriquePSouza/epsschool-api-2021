...
namespace EpsSchool.Tests.HandlersTests
{
    ...
    public class ChangeTeacherStatusHandlerTests
    {
        ...
        [TestMethod]
        [TestCategory("Handler")]
        public async Task Dado_um_comando_valido_deve_atualizar_o_registro_de_professor_inativo()
        {
        ...
        [TestMethod]
        [TestCategory("Handler")]
        public async Task Dado_um_comando_valido_deve_atualizar_o_registro_de_professor_ativo()
        {
