        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US"))),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse("05/28/2005", new System.Globalization.CultureInfo("en-US")))
                });
